    ...
    <section class="bg-white dark:bg-gray-900">
      <div class="container py-10 mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24 lg:pb-24">
          ...
          <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
              <div class="flex flex-col items-center p-6 space-y-3 text-center bg-blue-50 rounded-xl dark:bg-gray-800 transition duration-300 transform  shadow-sm hover:scale-105 group hover:shadow-xl lg:hover:bg-white sm:hover:bg-white" data-aos="fade-up" data-aos-delay="300">
