    ...
    <section class="bg-white">
      <div class="container py-10 mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24 lg:pb-24">
          ...
          <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
              <div class="flex flex-col items-center p-6 space-y-3 text-center bg-blue-500 rounded-xl dark:bg-gray-200 transition duration-300 transform  shadow-sm hover:scale-105 group hover:shadow-xl lg:hover:bg-white sm:hover:bg-white" data-aos="fade-up" data-aos-delay="300">
              ...
              <div class="flex flex-col items-center p-6 space-y-3 text-center bg-blue-50 rounded-xl dark:bg-gray-200 transition duration-300 transform  shadow-sm hover:scale-105 group hover:shadow-xl lg:hover:bg-white sm:hover:bg-white" data-aos="fade-up" data-aos-delay="300">
                  <span class="inline-block p-3 text-blue-600 bg-blue-100 rounded-full dark:text-white dark:bg-blue-600">
                      <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              -->
                  ...
                  class="button arrow inline-flex text-blue-600 items-center font-semibold text-base md:text-lg  duration-300 transform dark:text-blue-400 hover:underline hover:text-blue-600 dark:hover:text-blue-600">
                  Read more 
                </NuxtLink>
              </div>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
          </div>
