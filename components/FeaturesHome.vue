<template>
    <div class="dark:bg-gray-50">
        ...
        <div
            class="items-center max-w-screen-xl px-4 py-20 mx-auto lg:grid lg:grid-cols-4 lg:gap-16 xl:gap-24 lg:py-18 lg:px-8">
            <div class="col-span-2 mb-8">
                ...
                <div class="pt-6 mt-6 space-y-4 border-t border-gray-200">
                    <!-- <div>
                        <a href="#"
                            class="inline-flex items-center text-base font-medium text-blue-500 hover:text-blue-800">
            ...
            <div class="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
                <div>
                    <svg class="w-10 h-10 mb-2 text-blue-500 md:w-12 md:h-12" fill="currentColor"
                ...
                <div>
                    ...
                    <p class="font-light text-gray-500">Trusted by over 600 milion users around the world
                    </p>
                </div>
                <div>
                    <svg class="w-10 h-10 mb-2 text-blue-500 md:w-12 md:h-12" fill="currentColor"
                    ...
                    <p class="font-light text-gray-500">Have used Landwind to create functional websites
                    </p>
                </div>
                <div>
                    <svg class="w-10 h-10 mb-2 text-blue-500 md:w-12 md:h-12" fill="currentColor"
