          ...
          <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
            ...
            <div class="flex flex-col justify-center text-center md:text-left z-10">
              ...
              <div class="mt-6 sm:mt-8 flex flex-wrap gap-4">
                ...
                <a href="#learn-more" class="rounded-sm p-3 grow border text-center border-cyan-500 text-cyan-500 font-bold uppercase text-sm tracking-widest hover:bg-cyan-500 hover:text-black transition">
                  Learn More
                </a>
              </div>
            </div>
