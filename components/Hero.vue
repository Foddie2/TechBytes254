    ...
    >
      ...
      >
        <div class="max-w-xl ltr:sm:text-left" data-aos="fade-up" data-aos-delay="300">
          ...
          <p class="mt-4 max-w-lg lg:text-4xl text sm:text-xl/relaxed text-start text-stone-50">
          ...
          <!--   <a class="relative inline-flex items-center px-12 py-3 my-5 overflow-hidden text-lg font-medium text-white border-2 border-white rounded-full hover:text-black group hover:bg-blue-400">
              <NuxtLink to="/our-story">
              <span class="absolute left-0 block w-full h-0 transition-all bg-blue-400 opacity-100 group-hover:h-full top-1/2 group-hover:top-0 duration-400 ease group-hover:bg-gradient-to-r from-[#78f2b3] to-[#16f0de]"></span>
              ...
              <a class="relative inline-flex items-center px-12 py-3 overflow-hidden text-lg font-medium text-white border-2 border-white rounded-full hover:text-white group hover:bg-gray-50">
                ...
                <span class="absolute left-0 block w-full h-0 transition-all bg-blue-400 opacity-100 group-hover:h-full top-1/2 group-hover:top-0 duration-400 ease group-hover:bg-gradient-to-r from-[#7899f2] to-[#16b2f0]"></span>
                <span class="absolute right-0 flex items-center justify-start w-10 h-10 duration-300 transform translate-x-full group-hover:translate-x-0 ease">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                </span>
