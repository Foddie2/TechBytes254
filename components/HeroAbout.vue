<template>
    <div class="flex flex-1 w-full flex-col items-center justify-center text-center px-4 sm:mt-28 my-20">
           <!--  <a href="#" target="_blank" rel="noreferrer"
            ...
            <h1 class="mx-auto max-w-4xl font-display text-slate-900 sm:text-7xl text-3xl font-bold tracking-tight md:text-5xl">Make your
                photos
            ...
            <p class="mx-auto mt-8 max-w-xl text-lg text-slate-700 leading-7">Want to style up your photos? Maybe get that
