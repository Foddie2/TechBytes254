    ...
    <div class=" p-4 min-h-screen">
        <div class="max-w-7xl mx-auto h-max px-6 md:px-12 xl:px-6">
          <div class="md:w-2/3 lg:w-1/2">
            ...
            <h2 class="my-8 text-2xl font-bold text-stone-950 md:text-4xl">How we work?</h2>
          ...
          <div
            ...
            <div class="group relative bg-blue-50 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
