    ...
    <div class="flex flex-col justify-center space-y-5 md:flex-row md:space-y-0 md:space-x-6 lg:space-x-36 mt-7 mb-8">
        <div class="relative md:w-5/12">
            ...
            <div class="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                ...
                <button class="w-full px-6 py-3 text-xs text-white transition duration-300 ease-in-out transform border border-2 rounded-full lg:text-md focus:outline-none hover:scale-110 font-medium">Go to Docs</button>
            </div>
        </div>
         ...
         <div class="relative md:w-5/12">
            ...
            <div class="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                ...
                <button class="w-full px-6 py-3 text-xs text-white transition duration-300 ease-in-out transform bg-indigo-500 border-indigo-400 border border-2 rounded-full lg:text-md focus:outline-none hover:scale-110 font-medium">Go to Website</button>
            </div>
        </div>
    </div>
</div>
