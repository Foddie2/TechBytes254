<template>
<!-- component -->
<div class="bg-white relative   flex items-center  n justify-center overflow-hidden z-10 ">
        ...
        <div class="flex flex-col items-center justify-between lg:flex-row py-16">
            ...
            <div class="relative hidden lg:ml-32 lg:block lg:w-1/2">
                ...
                <div class="abg-orange-400 mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
                     <img src="https://img.freepik.com/premium-photo/technical-support-center-customer-service-internet-business-technology-concept_218381-5114.jpg">
                </div>
            </div>
        </div>
    </div> 
