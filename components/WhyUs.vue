<template>
    <div class="text-gray-700 body-font">
        <div class="flex justify-center mt-8 font-regular text-3xl font-bold sm:text-4xl">
          Why Us?
        </div>
        <div class="container px-5 py-6 mx-auto">
          <div class="flex flex-wrap text-center justify-center">
            <div class="p-4 md:w-1/4 sm:w-1/2">
              <div class="px-4 py-6 transform transition duration-500 hover:scale-110 hover:bg-blue-50 rounded-xl hover:shadow-lg">
                ...
                <h2 class="title-font font-regular text-2xl text-gray-900">Latest Technology</h2>
              </div>
            </div>
